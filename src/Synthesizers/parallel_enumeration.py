...
from Synthesizers.worklist_sketch_completion import *
...
def parallel_enumeration(sketch_list, demo, env, out_result, shared_LM, tp="GDFS", inf_check=False):
    ...
    if tp == "GDFS":
        processes = [Process(target=complete_sketch, args=(sketch_list[i], demo, env, shared_LM, 0, 0, tp, inf_check,
