...
def complete_sketch(sketch, demo, env, LM, num_checked=0, inf_caught=0, tp="GDFS", inf_check=False,
    ...
    while not W.empty():
        ...
        for prob, fill in hole_fills_sorted:
            ...
            if filled_by_LLM:
                ...
                new_sketch, temp_num_checked, temp_inf_caught, _ = complete_sketch(new_sketch, demo, env, LM, num_checked, inf_caught, tp, inf_check, out_result, inc_lock, prog_lock, lm_lock, done_event)
